...
- 2026-09-22 未发布：公开死亡粒子 + 头像常驻星芒（`feat/public-death-effects`，基线 `b3f5a1e`）；复用原合图，公开事件驱动，回归撤印，减少动画/关闭特效仍保留文字公告。增量单测 59/59，相关双浏览器 E2E 56/56、真实整局 chromium 1/1；两项前端类型检查及构建通过，未部署。详情见 `docs/frontend-v2-death-effects-verification.md`。
