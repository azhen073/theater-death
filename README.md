...
- 工程规格：`theater_death_development_requirements_v1.1.md`（当前 v2.0.5-alpha）
- 进度与交接：`PROGRESS.md`
- 版本号约定：**版本名 = 推送分支名**（当前 `2.0.5-alpha`）；工程版本与**规则版本**（1.1 / 2.0）、**客户端契约版本**（2.1 / 2.2）是三套独立编号，不互相换算
...
| `tests/` | Vitest 测试（590 用例 / 91 文件，全量通过）+ `fixtures/contract-2.1` 契约快照 |
