...
- 工程规格：`theater_death_development_requirements_v1.1.md`（当前 v2.0.2-alpha）
- 进度与交接：`PROGRESS.md`
...
- **syhneversigh**：贡献账号体系（数字 UID）、v2 稳定房间模型与租约、新版前端（web-v2）、契约 2.x 与验收测试等（PR #3，已按采用/调整说明整合进 `main`）；舞台行动 UX 与竖屏适配、团队方案「发布并确认本人」原子提交（PR #5，经维护方复核修复后整合进 `main`）
...
| `tests/` | Vitest 全量测试（556 用例）+ `fixtures/contract-2.1` 契约快照 |
