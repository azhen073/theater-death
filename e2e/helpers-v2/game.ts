...
export interface GameHarnessFixture { view: RoomSnapshot; catalog: CatalogDTO; online: boolean; active?: boolean; voice?: Record<string, unknown>; identityReveal?: 'enabled' | 'seen' }
