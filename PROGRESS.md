...
| 2.0.3-alpha（后续改动，贡献 kiahir） | 🚧 | 分支自 `2.0.2-beta` 的 tip（`c5df078`）拉出，2.0.2-beta 全部内容即其基线。计划：**局内麦克风音量显示**（方案 A/A+B/A+B+C 待定；纯本地信号不上报、受 R-43 时段门控、尊重减少动画、不改规则语义）+ 上一版遗留 F1/F3/F4、P1/P2 |
